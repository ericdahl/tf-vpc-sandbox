...
resource "aws_security_group_rule" "jumphost_10_2_0_0_egress" {
...
resource "aws_security_group_rule" "jumphost_10_2_0_0_ingress" {
  security_group_id = aws_security_group.jumphost_10_2_0_0.id
  type              = "ingress"
  from_port         = 22
  to_port           = 22
...
resource "aws_security_group_rule" "jumphost_10_2_0_0_ingress_rfc" {
  security_group_id = aws_security_group.jumphost_10_2_0_0.id
  type              = "ingress"
  from_port         = 0
  to_port           = 0
